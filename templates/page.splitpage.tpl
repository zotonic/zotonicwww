...
{% block content %}
	...
	<article id="content" class="{% block content_class %}zp-90{% endblock %}">
		<div class="padding">
	...
	<article id="content" class="{% block content_class %}zp-50{% endblock %}">
		<div class="padding">

			<div  {% block content_attributes %}{% endblock %}>
	...
	<article id="content" class="{% block content_class %}zp-45{% endblock %}">
